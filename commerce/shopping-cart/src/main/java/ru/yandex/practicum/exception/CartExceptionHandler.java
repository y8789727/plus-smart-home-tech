...
public class CartExceptionHandler {
    ...
    @ExceptionHandler({NoProductsInShoppingCartException.class, NoProductInWarehouse.class})
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Exception handleNotFoundException(final Exception e) {
    ...
    public Exception handleNotFoundException(final NoCartFound e) {
        log.warn("400 {}", e.getMessage(), e);
        return new Exception(e);
    }
